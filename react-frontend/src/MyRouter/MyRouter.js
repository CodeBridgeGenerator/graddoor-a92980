...
import SingleStudentPage from "../components/app_components/StudentPage/SingleStudentPage";
import StudentProjectLayoutPage from "../components/app_components/StudentPage/StudentProjectLayoutPage";
import SingleLecturerPage from "../components/app_components/LecturerPage/SingleLecturerPage";
import LecturerProjectLayoutPage from "../components/app_components/LecturerPage/LecturerProjectLayoutPage";
import SingleReviewPage from "../components/app_components/ReviewPage/SingleReviewPage";
import ReviewProjectLayoutPage from "../components/app_components/ReviewPage/ReviewProjectLayoutPage";
import SingleUniReviewPage from "../components/app_components/UniReviewPage/SingleUniReviewPage";
import UniReviewProjectLayoutPage from "../components/app_components/UniReviewPage/UniReviewProjectLayoutPage";
import SingleUniversityPage from "../components/app_components/UniversityPage/SingleUniversityPage";
import UniversityProjectLayoutPage from "../components/app_components/UniversityPage/UniversityProjectLayoutPage";
import SingleUniRankingPage from "../components/app_components/UniRankingPage/SingleUniRankingPage";
import UniRankingProjectLayoutPage from "../components/app_components/UniRankingPage/UniRankingProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/student/:singleStudentId" exact element={<SingleStudentPage />} />
<Route path="/student" exact element={<StudentProjectLayoutPage />} />
<Route path="/lecturer/:singleLecturerId" exact element={<SingleLecturerPage />} />
<Route path="/lecturer" exact element={<LecturerProjectLayoutPage />} />
<Route path="/review/:singleReviewId" exact element={<SingleReviewPage />} />
<Route path="/review" exact element={<ReviewProjectLayoutPage />} />
<Route path="/uniReview/:singleUniReviewId" exact element={<SingleUniReviewPage />} />
<Route path="/uniReview" exact element={<UniReviewProjectLayoutPage />} />
<Route path="/university/:singleUniversityId" exact element={<SingleUniversityPage />} />
<Route path="/university" exact element={<UniversityProjectLayoutPage />} />
<Route path="/uniRanking/:singleUniRankingId" exact element={<SingleUniRankingPage />} />
<Route path="/uniRanking" exact element={<UniRankingProjectLayoutPage />} />
