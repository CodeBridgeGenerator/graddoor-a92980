...
import seederData from "./student.seeder.json";
...
const StudentSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StudentSeederDialogComponent);
