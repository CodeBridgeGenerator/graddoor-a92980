...
import seederData from "./review.seeder.json";
...
const ReviewSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ReviewSeederDialogComponent);
