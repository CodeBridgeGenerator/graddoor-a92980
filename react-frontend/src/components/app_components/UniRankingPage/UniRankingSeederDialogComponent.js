...
import seederData from "./uniRanking.seeder.json";
...
const UniRankingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UniRankingSeederDialogComponent);
