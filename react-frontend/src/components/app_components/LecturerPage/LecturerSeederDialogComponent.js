...
import seederData from "./lecturer.seeder.json";
...
const LecturerSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LecturerSeederDialogComponent);
