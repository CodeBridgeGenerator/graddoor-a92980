...
const SingleUniversityPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("university")
            .get(urlParams.singleUniversityId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleUniversityId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">University</h3>
                    <SplitButton
                ...
                {/* <p>university/{urlParams.singleUniversityId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">WebsiteLink</label><p className="m-0 ml-3" >{_entity?.websiteLink}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Bannerphoto</label><p><img id="bannerphoto" src={_entity?.bannerphoto} className="m-0 ml-3" width={300}  /></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleUniversityId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleUniversityPage);
