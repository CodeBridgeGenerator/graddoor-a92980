...
import seederData from "./university.seeder.json";
...
const UniversitySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UniversitySeederDialogComponent);
