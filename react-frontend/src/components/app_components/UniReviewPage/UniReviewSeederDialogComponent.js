...
import seederData from "./uniReview.seeder.json";
...
const UniReviewSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UniReviewSeederDialogComponent);
