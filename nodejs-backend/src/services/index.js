...
const lecturer = require("./lecturer/lecturer.service.js");
const review = require("./review/review.service.js");
const uniReview = require("./uniReview/uniReview.service.js");
const university = require("./university/university.service.js");
const uniRanking = require("./uniRanking/uniRanking.service.js");
...
module.exports = function (app) {
  ...
  app.configure(lecturer);
  app.configure(review);
  app.configure(uniReview);
  app.configure(university);
  app.configure(uniRanking);
